    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-4 space-y-4 bg-white">
          ...
          {/* Playback Controls */}
          {hasVideo && recordingState !== "recording" && recordingState !== "paused" && (
            <div className="grid grid-cols-3 gap-3">
              ...
              <button
                onClick={saveVideo}
                className="bg-green-600 hover:bg-green-700 active:bg-green-800 text-white font-medium py-4 px-4 rounded-xl transition-colors shadow-lg flex flex-col items-center gap-1"
              >
              ...
              <button
                ...
                className="bg-gray-100 hover:bg-red-100 active:bg-red-200 text-gray-700 hover:text-red-600 font-medium py-4 px-4 rounded-xl transition-colors flex flex-col items-center gap-1"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
