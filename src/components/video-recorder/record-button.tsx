...
export function RecordButton({ 
  ...
  return (
    <button
      ...
      disabled={isDisabled}
      className={`w-full py-5 px-6 rounded-xl font-medium text-white flex items-center justify-center gap-3 transition-colors shadow-lg text-lg cursor-pointer ${
        isRecording
          ? "bg-red-600 hover:bg-red-700 active:bg-red-800"
          : "bg-linear-to-r from-[#ff3365] to-[#ff5580] hover:from-[#e62d58] hover:to-[#ff3365] active:from-[#d12950] active:to-[#e62d58] disabled:from-gray-300 disabled:to-gray-400"
